...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" type="number" name="textinput" placeholder="Enter a number" class="form-control input-md">
  </div>
</div>
...
def route_calc():
    num = request.form.get('textinput')
    return '<p>' + str(num) + ' * 5 = ' + str(int(num) * 5) + '</p>'
