...
def exercise01():
    ...
    animals = ['cat','dog','crouching tiget','hidden dragon','manta ray']
...
def exercise04(more_temperatures, iot_sensor_points, a, b, c, d, e):
    ...
    # ------ Place code below here \/ \/ \/ ------
    for temp in more_temperatures :
        temperatures.append(temp)

    for temp in iot_sensor_points.values() :
        temperatures.append(temp)
...
def exercise07(n):
    ...
    if len(n) in [0,1] :
        ...
        return n[0] in n[1:] or exercise07(n[1:])
...
def exercise10(sentence):
    ...
    for ch in sentence :
        if ch == ' ' :
            ...
            reversed = ch.lower() + reversed
        elif ch.islower() :
            reversed = ch.upper() + reversed
        else :
